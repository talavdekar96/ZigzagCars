...
public class HistorySingleActivity extends AppCompatActivity implements OnMapReadyCallback, RoutingListener {
    ...
    private DatabaseReference historyRideInfoDatabase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        historyRideInfoDatabase = FirebaseDatabase.getInstance().getReference().child("history").child(rideId);
        getRideInfo();
    }

    private void getRideInfo() {
        historyRideInfoDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
    ...
    private void displayCustomerRelatedObjects() {
        ...
        mRatingBar.setOnRatingBarChangeListener(new RatingBar.OnRatingBarChangeListener() {
            ...
            public void onRatingChanged(RatingBar ratingBar, float rating, boolean fromUser) {
                historyRideInfoDatabase.child("rating").setValue(rating);
                DatabaseReference mDriverRatingDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child("Drivers").child(driverId).child("rating");
                mDriverRatingDatabase.child(rideId).setValue(rating);
            }
        });
    }

    private void getUserInfo(String otherUserDriverOrCustomer, String otherUserId) {
        DatabaseReference mOtherUserDataBase = FirebaseDatabase.getInstance().getReference().child("Users").child(otherUserDriverOrCustomer).child(otherUserId);
